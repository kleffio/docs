...
import { SearchModal, SearchTrigger } from "./Search";
    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 h-14 border-b border-border bg-background/95 backdrop-blur-sm">
        <div className="flex h-full items-center gap-3 px-4 lg:px-6">
          ...
          {/* Search trigger — grows to fill the center */}
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="sm:hidden flex items-center justify-center w-8 h-8 rounded-md text-muted-foreground hover:text-foreground hover:bg-accent transition-colors"
